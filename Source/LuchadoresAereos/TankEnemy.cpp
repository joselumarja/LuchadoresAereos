...
void ATankEnemy::Shot() {
	...
	if (bCanFire)
	{
		...
		World->SpawnActor<AHeavyAmo>(SpawnLocation2, SpawnRotation2);
		...
		World->SpawnActor<AHeavyAmo>(SpawnLocation3, SpawnRotation3);
		...
		World->SpawnActor<AHeavyAmo>(SpawnLocation4, SpawnRotation4);
		...
		World->SpawnActor<AHeavyAmo>(SpawnLocation5, SpawnRotation5);
